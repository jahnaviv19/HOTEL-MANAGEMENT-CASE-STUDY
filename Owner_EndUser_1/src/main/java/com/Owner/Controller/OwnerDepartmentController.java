...
public class OwnerDepartmentController {
	...
	public Department addDept(@RequestBody Department dept) {
		return restTemplate.postForObject("http://localhost:4083/department/add/",dept,Department.class);
	...
	public DepartmentList getAlldept(){
		return restTemplate.getForObject("http://localhost:4083/department/findAll/", DepartmentList.class);
	}
	
	@GetMapping("/findById/{id}")
	public Department getEmp(@PathVariable("id") String id) 
	{
		return restTemplate.getForObject("http://localhost:4083/department/findById/"+id, Department.class);
		
	}
	@PutMapping("/update")
	public Department updateRoom(@RequestBody Department dept)
	{
		restTemplate.put("http://localhost:4083/department/update",dept, Department.class);
		return dept;
	}
	...
	{
		restTemplate.delete("http://localhost:4083/department/delete/"+id);
